          ...
          <a href="#" className="block size-full">
            ...
            <div className="flex flex-wrap items-center justify-center space-x-4 px-4 py-6 md:flex-nowrap md:justify-between">
              <div className="flex items-center">
                ...
                <p className="ml-2 border-b border-gray-200 text-xl  font-semibold text-white dark:text-white">
                  {valueFormatter(data.revenue)} $ Revenue
                </p>
              </div>
              <div className="flex items-center gap-16">
                <div className="mt-6 border-b border-gray-200 text-xl font-bold text-white dark:text-white md:mt-0">
